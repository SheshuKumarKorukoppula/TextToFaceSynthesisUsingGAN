...
main = tkinter.Tk()
main.title("A Realistic Image Generation of Face From Text Description Using the Fully Trained GAN") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='TEXT-TO-FACE SYNTHESIS USING FULLY TRAINED GENERATIVE ADVERSARIAL NETWORK')
title.config(bg='LightGreen', fg='white')  
